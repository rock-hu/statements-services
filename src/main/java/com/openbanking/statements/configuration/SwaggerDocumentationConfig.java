package com.openbanking.statements.configuration;
...
public class SwaggerDocumentationConfig {
	...
	Artifact artifact) {
		return GroupedOpenApi.builder().group("statements-services")
				...
				.packagesToScan("com.openbanking.statements.controller").build();
	}
